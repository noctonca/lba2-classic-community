...
fmt_imatstd_1	DB	"[ASM][InitMatrixStdF][1] Dst=%p a=%d b=%d g=%d", 10, 0

		public	C	InitMatrixStd
		public	C	InitMatrix

		InitMatrixStd	dd	offset InitMatrixStdF
		InitMatrix		dd	offset InitMatrixStdF
...
InitMatrixStdF	PROC
		...
		; --- debug trace [ASM][InitMatrixStdF][1] params ---
		pushad
		push	ecx
		push	ebx
		push	eax
		push	edi
		push	offset fmt_imatstd_1
		call	printf
		add	esp, 20
		popad
		; --- end debug trace ---
