...
;*══════════════════════════════════════════════════════════════════════════*
			...
			LightList	dd	offset LightListF

			Extrn	C printf:NEAR

fmt_litlist_1		DB	"[ASM][LightListF][1] Mat=%p dst=%p src=%p n=%d", 10, 0
...
LightListF		PROC
			...
			; --- debug trace [ASM][LightListF][1] params ---
			pushad
			push	ecx
			push	esi
			push	edi
			push	ebx
			push	offset fmt_litlist_1
			call	printf
			add	esp, 20
			popad
			; --- end debug trace ---
