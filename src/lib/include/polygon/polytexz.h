...
/* Perspective correction function pointers — defined as globals in
 * POLYTEXZ.CPP to support both CPP callers and ASM callers that
 * reference them as Extrn DWORD (indirect call via `call [symbol]`). */
