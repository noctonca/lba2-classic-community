        ...
        if (CheckCD()) {
            ...
            if (Tracks > 1) {
...
#ifdef _WIN32
                {
                    ...
                    snprintf(rootpath, sizeof(rootpath), "%c:\\", drive);
...
#else
                {
                    ...
                    snprintf(filter, sizeof(filter), "%c:\\*.*", drive);
