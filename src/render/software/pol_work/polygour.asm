...
IntGour             BYTE  12h
		...
		EXTRN	C	printf	:NEAR
fmt_f_gouraud_1	DB	"[ASM][Filler_Gouraud][1] entry", 10, 0
fmt_f_dither_1	DB	"[ASM][Filler_Dither][1] entry", 10, 0
fmt_f_gouraudtable_1	DB	"[ASM][Filler_GouraudTable][1] entry", 10, 0
fmt_f_dithertable_1	DB	"[ASM][Filler_DitherTable][1] entry", 10, 0
fmt_f_gouraudzbuf_1	DB	"[ASM][Filler_GouraudZBuf][1] entry", 10, 0
fmt_f_ditherzbuf_1	DB	"[ASM][Filler_DitherZBuf][1] entry", 10, 0
fmt_f_gouraudtablezb_1	DB	"[ASM][Filler_GouraudTableZBuf][1] entry", 10, 0
fmt_f_dithertablezbu_1	DB	"[ASM][Filler_DitherTableZBuf][1] entry", 10, 0
fmt_f_gouraudnzw_1	DB	"[ASM][Filler_GouraudNZW][1] entry", 10, 0
fmt_f_dithernzw_1	DB	"[ASM][Filler_DitherNZW][1] entry", 10, 0
fmt_f_gouraudtablenz_1	DB	"[ASM][Filler_GouraudTableNZW][1] entry", 10, 0
fmt_f_dithertablenzw_1	DB	"[ASM][Filler_DitherTableNZW][1] entry", 10, 0


fmt_filler_goura_1b	DB	"[ASM][Filler_Gouraud][1b] LeftSlope=%d RightSlope=%d curY=%d", 10, 0
fmt_filler_goura_1c	DB	"[ASM][Filler_Gouraud][1c] U_XS=%d V_XS=%d W_XS=%d ZBuf_XS=%d G_XS=%d", 10, 0
fmt_filler_goura_1d	DB	"[ASM][Filler_Gouraud][1d] U_LS=%d V_LS=%d W_LS=%d ZBuf_LS=%d G_LS=%d", 10, 0
fmt_filler_goura_1e	DB	"[ASM][Filler_Gouraud][1e] curU=%d curV=%d curW=%d curZBuf=%u curG=%d patch=%u", 10, 0
fmt_filler_dithe_1b	DB	"[ASM][Filler_Dither][1b] LeftSlope=%d RightSlope=%d curY=%d", 10, 0
fmt_filler_dithe_1c	DB	"[ASM][Filler_Dither][1c] U_XS=%d V_XS=%d W_XS=%d ZBuf_XS=%d G_XS=%d", 10, 0
fmt_filler_dithe_1d	DB	"[ASM][Filler_Dither][1d] U_LS=%d V_LS=%d W_LS=%d ZBuf_LS=%d G_LS=%d", 10, 0
fmt_filler_dithe_1e	DB	"[ASM][Filler_Dither][1e] curU=%d curV=%d curW=%d curZBuf=%u curG=%d patch=%u", 10, 0
...
Filler_Gouraud		PROC
		...
		; --- debug trace [ASM][Filler_Gouraud][1] entry ---
		pushad
		push	offset fmt_f_gouraud_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_DitherTableNZW][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		push	offset fmt_filler_dithe_1b
		call	printf
		add	esp, 16
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_DitherTableNZW][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurGouraudMin]
		push	dword ptr [Fill_CurZBufMin]
		push	offset fmt_filler_dithe_1e
		call	printf
		add	esp, 16
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_GouraudTableNZW][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		push	offset fmt_filler_goura_1b
		call	printf
		add	esp, 16
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_GouraudTableNZW][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurGouraudMin]
		push	dword ptr [Fill_CurZBufMin]
		push	offset fmt_filler_goura_1e
		call	printf
		add	esp, 16
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_DitherNZW][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_DitherNZW][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurGouraudMin]
		push	dword ptr [Fill_CurZBufMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_GouraudNZW][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_GouraudNZW][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurGouraudMin]
		push	dword ptr [Fill_CurZBufMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_DitherTableZBuf][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_DitherTableZBuf][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurGouraudMin]
		push	dword ptr [Fill_CurZBufMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_GouraudTableZBuf][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_GouraudTableZBuf][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurGouraudMin]
		push	dword ptr [Fill_CurZBufMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_DitherZBuf][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_DitherZBuf][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurGouraudMin]
		push	dword ptr [Fill_CurZBufMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_GouraudZBuf][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_GouraudZBuf][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurGouraudMin]
		push	dword ptr [Fill_CurZBufMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_DitherTable][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_DitherTable][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurGouraudMin]
		push	dword ptr [Fill_CurZBufMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_GouraudTable][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_GouraudTable][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurGouraudMin]
		push	dword ptr [Fill_CurZBufMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_Dither][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_Dither][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurGouraudMin]
		push	dword ptr [Fill_CurZBufMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_Gouraud][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_Gouraud][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurGouraudMin]
		push	dword ptr [Fill_CurZBufMin]
...
Filler_Dither		PROC
		...
		; --- debug trace [ASM][Filler_Dither][1] entry ---
		pushad
		push	offset fmt_f_dither_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
Filler_GouraudTable	PROC
		...
		; --- debug trace [ASM][Filler_GouraudTable][1] entry ---
		pushad
		push	offset fmt_f_gouraudtable_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
Filler_DitherTable	PROC
		...
		; --- debug trace [ASM][Filler_DitherTable][1] entry ---
		pushad
		push	offset fmt_f_dithertable_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
Filler_GouraudZBuf	PROC
		...
		; --- debug trace [ASM][Filler_GouraudZBuf][1] entry ---
		pushad
		push	offset fmt_f_gouraudzbuf_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
Filler_DitherZBuf	PROC
		...
		; --- debug trace [ASM][Filler_DitherZBuf][1] entry ---
		pushad
		push	offset fmt_f_ditherzbuf_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
Filler_GouraudTableZBuf	PROC
		...
		; --- debug trace [ASM][Filler_GouraudTableZBuf][1] entry ---
		pushad
		push	offset fmt_f_gouraudtablezb_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
Filler_DitherTableZBuf	PROC
		...
		; --- debug trace [ASM][Filler_DitherTableZBuf][1] entry ---
		pushad
		push	offset fmt_f_dithertablezbu_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
Filler_GouraudNZW	PROC
		...
		; --- debug trace [ASM][Filler_GouraudNZW][1] entry ---
		pushad
		push	offset fmt_f_gouraudnzw_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
Filler_DitherNZW	PROC
		...
		; --- debug trace [ASM][Filler_DitherNZW][1] entry ---
		pushad
		push	offset fmt_f_dithernzw_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
Filler_GouraudTableNZW	PROC
		...
		; --- debug trace [ASM][Filler_GouraudTableNZW][1] entry ---
		pushad
		push	offset fmt_f_gouraudtablenz_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
Filler_DitherTableNZW	PROC
		...
		; --- debug trace [ASM][Filler_DitherTableNZW][1] entry ---
		pushad
		push	offset fmt_f_dithertablenzw_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
