...
IntMapU             BYTE  12h
		...
		EXTRN	C	printf	:NEAR
fmt_f_texture_1	DB	"[ASM][Filler_Texture][1] entry", 10, 0
fmt_f_textureflat_1	DB	"[ASM][Filler_TextureFlat][1] entry", 10, 0
fmt_f_texturechromak_1	DB	"[ASM][Filler_TextureChromaKey][1] entry", 10, 0
fmt_f_textureflatchr_1	DB	"[ASM][Filler_TextureFlatChromaKey][1] entry", 10, 0


fmt_filler_textu_1b	DB	"[ASM][Filler_Texture][1b] LeftSlope=%d RightSlope=%d curY=%d", 10, 0
fmt_filler_textu_1c	DB	"[ASM][Filler_Texture][1c] U_XS=%d V_XS=%d W_XS=%d ZBuf_XS=%d G_XS=%d", 10, 0
fmt_filler_textu_1d	DB	"[ASM][Filler_Texture][1d] U_LS=%d V_LS=%d W_LS=%d ZBuf_LS=%d G_LS=%d", 10, 0
fmt_filler_textu_1e	DB	"[ASM][Filler_Texture][1e] curU=%d curV=%d curW=%d curZBuf=%u curG=%d patch=%u", 10, 0
...
Filler_Texture		PROC
		...
		; --- debug trace [ASM][Filler_Texture][1] entry ---
		pushad
		push	offset fmt_f_texture_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureFlatChromaKey][1b] slopes ---
		pushad
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureFlatChromaKey][1e] curvals ---
		pushad
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureFlat][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureFlat][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurZBufMin]
		push	dword ptr [Fill_CurMapVMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureChromaKey][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureChromaKey][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurZBufMin]
		push	dword ptr [Fill_CurMapVMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_Texture][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_Texture][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurZBufMin]
		push	dword ptr [Fill_CurMapVMin]
...
Filler_TextureChromaKey	PROC
		...
		; --- debug trace [ASM][Filler_TextureChromaKey][1] entry ---
		pushad
		push	offset fmt_f_texturechromak_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
Filler_TextureFlat	PROC
		...
		; --- debug trace [ASM][Filler_TextureFlat][1] entry ---
		pushad
		push	offset fmt_f_textureflat_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
Filler_TextureFlatChromaKey PROC
		...
		; --- debug trace [ASM][Filler_TextureFlatChromaKey][1] entry ---
		pushad
		push	offset fmt_f_textureflatchr_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
