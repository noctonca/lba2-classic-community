...
PtrCLUT         DWORD 12345678h
		...
		EXTRN	C	printf	:NEAR
fmt_f_texturez_1	DB	"[ASM][Filler_TextureZ][1] entry", 10, 0
fmt_f_texturezflat_1	DB	"[ASM][Filler_TextureZFlat][1] entry", 10, 0
fmt_f_texturezchroma_1	DB	"[ASM][Filler_TextureZChromaKey][1] entry", 10, 0
fmt_f_texturezflatch_1	DB	"[ASM][Filler_TextureZFlatChromaKey][1] entry", 10, 0


fmt_filler_textu_1b	DB	"[ASM][Filler_TextureZ][1b] LeftSlope=%d RightSlope=%d curY=%d", 10, 0
fmt_filler_textu_1c	DB	"[ASM][Filler_TextureZ][1c] U_XS=%d V_XS=%d W_XS=%d ZBuf_XS=%d G_XS=%d", 10, 0
fmt_filler_textu_1d	DB	"[ASM][Filler_TextureZ][1d] U_LS=%d V_LS=%d W_LS=%d ZBuf_LS=%d G_LS=%d", 10, 0
fmt_filler_textu_1e	DB	"[ASM][Filler_TextureZ][1e] curU=%d curV=%d curW=%d curZBuf=%u curG=%d patch=%u", 10, 0
...
Filler_TextureZ		PROC
		...
		; --- debug trace [ASM][Filler_TextureZ][1] entry ---
		pushad
		push	offset fmt_f_texturez_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureZFlatChromaKey][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		push	offset fmt_filler_textu_1b
		call	printf
		add	esp, 16
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureZFlatChromaKey][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurZBufMin]
		push	dword ptr [Fill_CurWMin]
		push	dword ptr [Fill_CurMapVMin]
		push	dword ptr [Fill_CurMapUMin]
		push	offset fmt_filler_textu_1e
		call	printf
		add	esp, 24
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureZChromaKey][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureZChromaKey][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurZBufMin]
		push	dword ptr [Fill_CurWMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureZFlat][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureZFlat][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurZBufMin]
		push	dword ptr [Fill_CurWMin]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureZ][1b] slopes ---
		pushad
		push	dword ptr [Fill_CurY]
		push	dword ptr [Fill_RightSlope]
		push	dword ptr [Fill_LeftSlope]
		...
		popad
		; --- end debug trace ---
		; --- debug trace [ASM][Filler_TextureZ][1e] curvals ---
		pushad
		push	dword ptr [Fill_Patch]
		push	dword ptr [Fill_CurZBufMin]
		push	dword ptr [Fill_CurWMin]
...
Filler_TextureZFlat	PROC
		...
		; --- debug trace [ASM][Filler_TextureZFlat][1] entry ---
		pushad
		push	offset fmt_f_texturezflat_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
@@Each_Line:
			mov	eax,[Fill_LeftSlope]
Fill_VLTextureZ2::	add	edi,[ScreenPitch]
...
Filler_TextureZChromaKey PROC
		...
		; --- debug trace [ASM][Filler_TextureZChromaKey][1] entry ---
		pushad
		push	offset fmt_f_texturezchroma_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
@@Each_Line:
			mov	eax,[Fill_LeftSlope]
Fill_VLTextureZ3::	add	edi,[ScreenPitch]
...
Filler_TextureZFlatChromaKey PROC
		...
		; --- debug trace [ASM][Filler_TextureZFlatChromaKey][1] entry ---
		pushad
		push	offset fmt_f_texturezflatch_1
		call	printf
		add	esp, 4
		popad
		; --- end debug trace ---
...
@@Each_Line:
			mov	eax,[Fill_LeftSlope]
Fill_VLTextureZ4::	add	edi,[ScreenPitch]
...
@@Each_Line:
			mov	eax,[Fill_LeftSlope]
Fill_VLTextureZ5::	add	edi,[ScreenPitch]
...
@@Each_Line:
			mov	eax,[Fill_LeftSlope]
Fill_VLTextureZ6::	add	edi,[ScreenPitch]
...
@@Each_Line:
			mov	eax,[Fill_LeftSlope]
Fill_VLTextureZ7::	add	edi,[ScreenPitch]
...
@@Each_Line:
			mov	eax,[Fill_LeftSlope]
Fill_VLTextureZ8::	add	edi,[ScreenPitch]
...
@@Each_Line:
			mov	eax,[Fill_LeftSlope]
Fill_VLTextureZ9::	add	edi,[ScreenPitch]
