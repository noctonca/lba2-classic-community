    ...
    case RAIL_NORD_EST: // virage NORD-EST
        if (ptrobj->Info1 != 1) {
            ...
            if (ptrobj->Obj.Beta <= (512 * MUL_ANGLE)) {
                ...
                ptrobj->Info2 =
                    (ptrobj->Obj.X / SIZE_BRICK_XZ) * SIZE_BRICK_XZ + 2 * SIZE_BRICK_XZ;
                ...
                ptrobj->Info3 =
                    (ptrobj->Obj.Z / SIZE_BRICK_XZ) * SIZE_BRICK_XZ + 2 * SIZE_BRICK_XZ;
            }
            ptrobj->Sprite = 0;
        }
        break;
    ...
    case RAIL_SUD_EST: // virage SUD-EST
        if (ptrobj->Info1 != 1) {
            ...
            if (ptrobj->Obj.Beta < (512 * MUL_ANGLE)) {
                ...
                ptrobj->Info2 = (ptrobj->Obj.X / SIZE_BRICK_XZ) * SIZE_BRICK_XZ + SIZE_BRICK_XZ - 1;
                ptrobj->Info3 =
                    (ptrobj->Obj.Z / SIZE_BRICK_XZ) * SIZE_BRICK_XZ - SIZE_BRICK_XZ - 1;
            }
            ptrobj->Sprite = 0;
        }
        break;
    ...
    case RAIL_NORD_OUEST: // virage NORD-OUEST
        if (ptrobj->Info1 != 1) {
            ...
            if (ptrobj->Obj.Beta <= (256 * MUL_ANGLE)) {
                ...
                ptrobj->Info = 1; /// Gauche
                ptrobj->Info2 =
                    (ptrobj->Obj.X / SIZE_BRICK_XZ) * SIZE_BRICK_XZ - SIZE_BRICK_XZ - 1;
                ptrobj->Info3 = (ptrobj->Obj.Z / SIZE_BRICK_XZ) * SIZE_BRICK_XZ + SIZE_BRICK_XZ - 1;
            }
            ptrobj->Sprite = 0;
        }
...
S32 GetNumBrickWagon(S32 brick) {
    ...
    {
        switch (brick) {
        case RAIL_E_NORD_SUD:
            return RAIL_NORD_SUD;
        case RAIL_E_EST_OUEST:
            return RAIL_EST_OUEST;
        case RAIL_E_UP_NORD:
            return RAIL_UP_NORD;
        case RAIL_E_UP_SUD:
            return RAIL_UP_SUD;
        case RAIL_E_UP_EST:
            return RAIL_UP_EST;
        case RAIL_E_UP_OUEST:
            return RAIL_UP_OUEST;
        case RAIL_E_NORD_EST:
            return RAIL_NORD_EST;
        case RAIL_E_NORD_OUEST:
            return RAIL_NORD_OUEST;
        case RAIL_E_SUD_EST:
            return RAIL_SUD_EST;
        case RAIL_E_SUD_OUEST:
            return RAIL_SUD_OUEST;
        case RAIL_E_NORD_NORD_EST:
            return RAIL_NORD_NORD_EST;
        case RAIL_E_NORD_NORD_OUEST:
            return RAIL_NORD_NORD_OUEST;
        case RAIL_E_SUD_SUD_EST:
            return RAIL_SUD_SUD_EST;
        case RAIL_E_SUD_SUD_OUEST:
            return RAIL_SUD_SUD_OUEST;
        case RAIL_E_OUEST_OUEST_SUD:
            return RAIL_OUEST_OUEST_SUD;
        case RAIL_E_OUEST_OUEST_NORD:
            return RAIL_OUEST_OUEST_NORD;
        case RAIL_E_EST_EST_SUD:
            return RAIL_EST_EST_SUD;
        case RAIL_E_EST_EST_NORD:
            return RAIL_EST_EST_NORD;
        }
...
void AdjustEssieuWagonAvant(S32 brickw) {
    ...
    case RAIL_UP_NORD:
        ...
        if (APtObj->Obj.Beta == 2048) {
            ...
            zess = APtObj->Obj.Z + Z0;
            yess = APtObj->Obj.Y;
            if (diff OR brickw != RAIL_UP_NORD)
                yess -= SIZE_BRICK_Y;
    ...
    case RAIL_UP_OUEST:
        ...
        if (APtObj->Obj.Beta == 3072 OR brickw == RAIL_NORD_OUEST) {
            ...
            xess = APtObj->Obj.X + X0;
            yess = APtObj->Obj.Y;
            if (diff OR brickw != RAIL_UP_OUEST)
                yess -= SIZE_BRICK_Y;
    ...
    default:
        ...
        if (APtObj->Coord.SHit.SHitX < 0) {
            ...
            APtObj->Obj.CurrentFrame[0].Beta = 0;
        break;
    }
