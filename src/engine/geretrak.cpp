...
void DoTrack(U8 numobj) {
    ...
    while (flag) {
        ...
        case TM_SPEED:
            ...
            if (ptrobj->Flags & SPRITE_3D) { /* voir pour les 2 types ? */
        ...
        case TM_START_ANIM_3DS:
            ...
            if (ptrobj->Flags & ANIM_3DS) {
                ...
                ptrobj->SizeSHit = n;
                ptrobj->PtrFile3D = (U8 *)(uintptr_t)(U32)TimerRefHR;
            }
            break;
        ...
        case TM_WAIT_ANIM_3DS:
            if (ptrobj->Flags & ANIM_3DS) {
                if (ptrobj->Sprite != ptrobj->Coord.A3DS.Fin AND ptrobj->SizeSHit != 0) // NbFps
                {
                    ptrobj->OffsetTrack--;
                    flag = FALSE;
                }
