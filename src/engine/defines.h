...
/* Same `sprites.hqr` index as the original UI cursor (`SPRITE_CURSOR` in COMMON.H); see docs/MENU.md. */
#define MENU_MOUSE_SPRITE_HQR_INDEX SPRITE_CURSOR
...
/* TYPE_OBJ_3D … TYPE_EXTRA: COMMON.H (included above). */
