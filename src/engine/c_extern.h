...
#ifdef DEMO
extern char *Version; /* "<product> <version> (<date> / <time>)" banner (VERSION.CPP) */
#else
extern const char *Version; /* "<product> <version> (<date> / <time>)" banner (VERSION.CPP) */
#endif
